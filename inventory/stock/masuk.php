                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="active">
                                    <li class="active"><a href="masuk.php">Ikan Masuk / Kembali</a></li>
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                    ...
                                                    <div class="modal fade" id="del<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <!-- Modal body -->
                                                            <div class="modal-body">
                                                            Apakah Anda yakin ingin menghapus barang ini dari daftar stock Ikan  masuk?
                                                            <br>
	...
	<!-- modal input -->
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Input Ikan Masuk</h4>
						</div>
						<div class="modal-body">
							<form action="barang_masuk_act.php" method="post">
								...
								<div class="form-group">
									<label>Jumlah</label>
									<input name="qty" type="number" min="1" class="form-control" placeholder="Stock">
								</div>
								<div class="form-group">
