    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="../lg.png" alt="lg" width="100%"></a>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="stock.php"><i class="ti-dashboard"></i><span>Stock Ikan</span></a>
                            </li>
							<li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Transaksi Data Ikan
                                    </span></a>
                                <ul class="collapse">
                                    <li><a href="masuk.php">Ikan Masuk / Kembali</a></li>
                                    <li><a href="keluar.php">Ikan Keluar</a></li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Daftar Ikan</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right" style="color:black; padding:0px;">
                            <img src="lg.jpg" width="220px" class="user-name dropdown-toggle" data-toggle="dropdown"\>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                                ...
                                                <!-- The Modal -->
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <!-- Modal body -->
                                                            <div class="modal-body">
                                                            Apakah Anda yakin ingin menghapus barang ini dari daftar stock Ikan?
                                                            <input type="hidden" name="idbrg" value="<?=$idb;?>">
                                                            </div>
									...
									<a href="exportstkbhn.php" target="_blank" class="btn btn-info">Export Data Ikan</a>
                                </div>
                            </div>
                        </div>
                    </div>
	...
	<!-- modal input -->
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Masukkan stok Ikan manual</h4>
						</div>
						<div class="modal-body">
							<form action="tmb_brg_act.php" method="post">
								<div class="form-group">
									<label>Nama Ikan</label>
									<input name="nama" type="text" class="form-control" placeholder="Nama Ikan" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>Harga</label>
									<input name="merk" type="number" min="0" class="form-control" placeholder="Harga">
								</div>
								<div class="form-group">
									<label>Berat</label>
									<input name="ukuran" type="text" class="form-control" placeholder="Berat">
								</div>
								<div class="form-group">
									<label>Jumlah</label>
									<input name="stock" type="number" min="0" class="form-control" placeholder="Stock">
								</div>
								<div class="form-group">
									<label>Satuan</label>
									<select name="satuan" class="custom-select form-control">
									<option selected>Pilih satuan</option>
									<option value="Gram/Rp">Ekor/Rp</option>
									<option value="Kilogram/Rp">Kilogram/Rp</option>
									<option value="Miligram/Rp">Bungkus/Rp</option>
									</select>
								</div>
								<div class="form-group">
									<label>Lokasi</label>
